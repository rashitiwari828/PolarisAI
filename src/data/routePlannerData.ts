...
export const routeOptions: RouteOption[] = [
  {
    ...
    iceExposure: "HIGH",
    riskScore: 32,
    description: "Shortest transit time with increased ice exposure.",
  },
  {
    id: "safest",
    name: "SAFEST",
    ...
    iceExposure: "LOW",
    riskScore: 7,
    description: "Lowest overall navigation risk with additional transit time.",
  },
  {
    id: "optimal",
...
export const decisionFactors = [
  {
    title: "Avoids 3 high-density ice regions (>75% concentration)",
    detail: "14% lower ice exposure",
  },
  {
    title: "Avoids predicted iceberg A23 trajectory with 5 nm buffer",
    detail: "72h collision risk eliminated",
  },
  {
    title: "Routes through northern passage at lower latitude",
    detail: "~180 km longer than fastest",
  },
  {
    title: "Avoids strong NE headwind corridor (28–34 kn forecast)",
    detail: "~6% fuel saving from wind",
  },
  {
    title: "8 hours faster than the safest alternative route",
